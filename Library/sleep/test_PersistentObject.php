...
try
{
	...
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$collection = new OntologyWrapper\MongoCollection( $dsn );'.kSTYLE_HEAD_POS );
	$collection = new OntologyWrapper\MongoCollection( $dsn );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	...
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$test[ kTAG_PID ] = "Global identifier";'.kSTYLE_HEAD_POS );
	$test[ kTAG_PID ] = "Global identifier";
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	echo( '<pre>' ); print_r( $test ); echo( '</pre>' );
