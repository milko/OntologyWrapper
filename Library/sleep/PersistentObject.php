 ...
 *======================================================================================*/
	...
	public function insert( $theWrapper = NULL, $theOptions = kFLAG_OPT_REL_ONE )
	{
		...
		if( ! $this->isCommitted() )
		{
			...
			// Open batch.
			//
			$batch = $theWrapper->hasBatch();
			$theWrapper->openBatch( FALSE );
	...
	public function commit( $theWrapper = NULL, $theOptions = kFLAG_OPT_REL_ONE )
	{
		...
		$id = ( $this->isCommitted() )
			...
			: $this->insertObject( $collection, $theOptions );
 ...
 *======================================================================================*/
	 ...
	 *	 </ul>
	 *	<li>We execute the insert methof of the current wrapper.
 ...
 *======================================================================================*/
												   ...
												   $theCount = 1 )
	{
		...
		//
		$modifications
			= array( '$inc' => array( (string) $tag_ref_count => (int) $theCount ) );
