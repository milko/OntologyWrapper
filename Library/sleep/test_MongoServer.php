...
/**
 * {@link MongoServer} test suite.
 *
 * This file contains routines to test and demonstrate the behaviour of the
 * {@link MongoServer} class.
 *
...
// Cast current class.
//
class MyClass extends OntologyWrapper\connection\MongoServer{}
...
try
{
	...
	if( kDEBUG_PARENT )
	{
		...
		//
		// Instantiate empty closed object.
		//
		echo( '<h4>Instantiate empty closed object</h4>' );
		echo( kSTYLE_TABLE_PRE );
		echo( kSTYLE_ROW_PRE );
		echo( kSTYLE_HEAD_PRE.'$test = new MyClass( "mongodb://localhost:27017?connect=0" );'.kSTYLE_HEAD_POS );
		$test = new MyClass();
		echo( kSTYLE_ROW_POS );
		echo( kSTYLE_ROW_PRE );
		echo( kSTYLE_DATA_PRE );
		...
		//
		// Test instantiate closed with valid parameters.
		//
		echo( '<h4>Test instantiate closed with valid parameters</h4>' );
		echo( kSTYLE_TABLE_PRE );
		echo( kSTYLE_ROW_PRE );
		echo( kSTYLE_HEAD_PRE.'$test = new MyClass();'.kSTYLE_HEAD_POS );
		$test = new MyClass();
		...
		echo( kSTYLE_ROW_PRE );
		echo( kSTYLE_HEAD_PRE );
		echo( '$test[ kTAG_CONN_PROTOCOL ] = "mongodb";<br>' );
		$test[ kTAG_CONN_PROTOCOL ] = "mongodb";
		echo( '$test[ kTAG_CONN_HOST ] = "localhost";<br>' );
		$test[ kTAG_CONN_HOST ] = "localhost";
		echo( '$test[ kTAG_CONN_PORT ] = 27017;<br>' );
		$test[ kTAG_CONN_PORT ] = 27017;
		echo( '$test[ kTAG_CONN_OPTS ] = array( "connect" => 0 );<br>' );
		$test[ kTAG_CONN_OPTS ] = array( "connect" => 0 );
		echo( kSTYLE_HEAD_POS );
		echo( kSTYLE_ROW_POS );
		echo( kSTYLE_ROW_PRE );
		echo( kSTYLE_DATA_PRE );
	...
	//
	// Test instantiate object with parameters.
	//
	echo( '<h4>Test instantiate with parameters<br /><i>we use here a list of hosts</i></h4>' );
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$test = new MyClass();'.kSTYLE_HEAD_POS );
	$test = new MyClass();
	...
	echo( '$test[ kTAG_CONN_PROTOCOL ] = "mongodb";<br>' );
	$test[ kTAG_CONN_PROTOCOL ] = "mongodb";
	echo( '$test[ kTAG_CONN_HOST ] = array( "localhost:27017", "192.168.181.11:27017" );<br>' );
	$test[ kTAG_CONN_HOST ] = array( "localhost:27017", "192.168.181.11:27017" );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
