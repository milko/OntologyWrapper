...
try
{
	...
	(
		...
		kTAG_CONN_PORT => "80",
		-4 => array( kTAG_TYPE => 'LineString',
					 kTAG_GEOMETRY => array( array( '25', '32' ),
					 							   array( '37', '42' ),
					 							   array( '59', '63.26' ),
					 							   array( '89', '71.12' ) ) ),
	...
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( 'TAG [:connection:port]' );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	$x = new OntologyWrapper\Tag( $wrapper, ":connection:port" );
	var_dump( $x[ kTAG_UNIT_COUNT ] );
	echo( kSTYLE_DATA_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( 'TAG [:connection:protocol]' );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	$x = new OntologyWrapper\Tag( $wrapper, ":connection:protocol" );
	var_dump( $x[ kTAG_UNIT_COUNT ] );
	echo( kSTYLE_DATA_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_TABLE_POS );
	...
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( '$test[ kTAG_DATA_KIND ] = [ ":connection:port" ];<br />' );
	$test[ kTAG_DATA_KIND ] = [ ":connection:port" ];
	echo( '$test[ kTAG_CONN_PORT ] = NULL;<br />' );
	$test[ kTAG_CONN_PORT ] = NULL;
	echo( '$test[ kTAG_LABEL ] = NULL;<br />' );
	$test[ kTAG_LABEL ] = NULL;
	echo( '$test[ "-3.".kTAG_NAME ] = NULL;<br />' );
	$test[ "-3.".kTAG_NAME ] = NULL;
	echo( '$test[ kTAG_CONN_PROTOCOL ] = "UNKNOWN";<br />' );
	$test[ kTAG_CONN_PROTOCOL ] = "UNKNOWN";
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$id = $test->commit();'.kSTYLE_HEAD_POS );
