...
try
{
	...
	//
	echo( "\nInstantiate empty object\n" );
	echo( '$test = new OntologyWrapper\DocumentObject();'."\n" );
	...
	echo( '$test1 = new OntologyWrapper\DocumentObject( array( "test" => "TEST" ) );'."\n" );
	$test1 = new OntologyWrapper\DocumentObject( array( 'test' => 'TEST' ) );
	echo( '$test2 = new OntologyWrapper\DocumentObject( array( "test2" => "TEST2" ) );'."\n" );
	$test2 = new OntologyWrapper\DocumentObject( array( 'test2' => 'TEST2' ) );
	echo( '$test = new OntologyWrapper\DocumentObject( array( "one" => $test1, "two" => $test2, new ArrayObject( array( 1, 2, 3 ) ) ) );'."\n" );
