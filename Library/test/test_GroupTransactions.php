...
try
{
	...
	//
	// Group by status, collection, alias, error type, value and error code.
	//
	echo( '<h4>Group by status, collection, alias, error type, value and error code</h4>' );
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( 'Request:' );
