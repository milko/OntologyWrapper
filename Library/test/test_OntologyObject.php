...
try
{
	...
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$props = $test->collectProperties( FALSE );'.kSTYLE_HEAD_POS );
	$props = $test->collectProperties( FALSE );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	...
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$props = $test->collectProperties();'.kSTYLE_HEAD_POS );
	$props = $test->collectProperties();
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	echo( '<pre>' ); print_r( $props ); echo( '</pre>' );
