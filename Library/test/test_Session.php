...
try
{
	...
	echo( '$upload->type( kTYPE_SESSION_UPLOAD );<br />' );
	$upload->type( kTYPE_SESSION_UPLOAD );
	echo( '$upload->user( $user )<br />;' );
	$upload->user( $user );
	echo( '$upload_id = $upload->commit();' );
	$uploas_id = $upload->commit();
	...
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( '$data = $upload->end( TRUE );' );
	$data = $upload->end( TRUE );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	...
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( '$data = $upload->status( kTYPE_STATUS_OK );' );
	$data = $upload->status( kTYPE_STATUS_OK );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	...
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( '$upload->processed( 1 );</br />' );
	$upload->processed( 1 );
	echo( '$upload->validated( 2 );</br />' );
	$upload->validated( 2 );
	echo( '$upload->rejected( 3 );</br />' );
	$upload->rejected( 3 );
	echo( '$upload->skipped( 4 );</br />' );
	$upload->skipped( 4 );
	echo( '$data = $upload->counters();' );
	$data = $upload->counters();
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
