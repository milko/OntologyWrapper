 ...
 *	@version	1.00 02/03/2014
 */

/*=======================================================================================
 *																						*
 *									test_EntityObject.php								*
 *																						*
 *======================================================================================*/
...
// Cast current class.
//
class MyClass extends OntologyWrapper\EntityObject
{
...
try
{
	...
	$test->Mail( "home", "Via leMani dal Naso, 25\n00057 Caccarese (RM)\nITALIA" );
	echo( '$test->Email( "work", "me@mail.com" );<br />' );
	$test->Email( "work", "me@mail.com" );
	echo( '$test->Email( "home", "me@mail.net" );<br />' );
	$test->Email( "home", "me@mail.net" );
	echo( '$test->Phone( "work", "+39 06 6118286" );<br />' );
	$test->Phone( "work", "+39 06 6118286" );
	echo( '$test->Phone( "home", "+39 06 7118563" );<br />' );
	$test->Phone( "home", "+39 06 7118563" );
	echo( '$test->Fax( NULL, "+39 06 7118565" );<br />' );
	$test->Fax( NULL, "+39 06 7118565" );
	echo( '$test[ kTAG_ENTITY_COUNTRY ] = "ITA";' );
	$test[ kTAG_ENTITY_COUNTRY ] = "ITA";
	echo( '$test->Affiliation( "default", ":domain:unit://authority/collection:identifier;" );' );
	$test->Affiliation( "default", ":domain:unit://authority/collection:identifier;" );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
