...
/**
 * {@link ServerObject} test suite.
 *
 * This file contains routines to test and demonstrate the behaviour of the
 * {@link ServerObject} class.
 *
...
// Cast current class.
//
class MyClass extends OntologyWrapper\ServerObject
{
	protected function newDatabase( $theOffsets )		{	return $theOffsets;	}
...
try
{
	...
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	$dsn = "protocol://user:pass@host:80?opt1=val1&opt2=val2&opt3&opt4";
	echo( kSTYLE_HEAD_PRE );
	var_dump( $dsn );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	...
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$value = $test->Database( "database" );'.kSTYLE_HEAD_POS );
