...
// Cast current class.
//
class MyClass extends OntologyWrapper\Node
{
...
try
{
	...
	// Load term.
	//
	echo( '<h4>Load term</h4>' );
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$ns = $test->getReferenced();'.kSTYLE_HEAD_POS );
	$ns = $test->getReferenced();
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	...
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$test[ kTAG_TAG ] = ":label";'.kSTYLE_HEAD_POS );
	$test[ kTAG_TAG ] = ":label";
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$id = $test->commit( $wrapper );'.kSTYLE_HEAD_POS );
	...
	// Create alias object.
	//
	echo( '<h4>Create alias object</h4>' );
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE.'$test = new MyClass( $wrapper );'.kSTYLE_HEAD_POS );
	$test = new MyClass( $wrapper );
	...
	// Load alias object.
	//
	echo( '<h4>Load alias object</h4>' );
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( '$test = new MyClass( $wrapper, $id );' );
	...
	//
	echo( '<h4>Traverse object properties</h4>' );
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( '$test->collectProperties( $tags, $refs );' );
	$test->collectProperties( $tags, $refs );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	...
	//
	echo( '<h4>Get tag master object</h4>' );
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( '$node = MyClass::GetTagMaster( $wrapper, ":label", kQUERY_OBJECT );' );
	$node = MyClass::GetTagMaster( $wrapper, ":label", kQUERY_OBJECT );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
	var_dump( $node->getArrayCopy() );
	echo( kSTYLE_DATA_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_TABLE_POS );
	echo( '<hr>' );
	...
	//
	echo( '<h4>Get term master object</h4>' );
	echo( kSTYLE_TABLE_PRE );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_HEAD_PRE );
	echo( '$node = MyClass::GetTermMaster( $wrapper, ":type", kQUERY_OBJECT );' );
	$node = MyClass::GetTermMaster( $wrapper, ":type", kQUERY_OBJECT );
	echo( kSTYLE_HEAD_POS );
	echo( kSTYLE_ROW_POS );
	echo( kSTYLE_ROW_PRE );
	echo( kSTYLE_DATA_PRE );
