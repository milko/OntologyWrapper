...
/**
 * {@link Individual} test suite.
 *
 * This file contains routines to test and demonstrate the behaviour of the
 * {@link Individual} class.
 *
...
// Cast current class.
//
class MyClass extends OntologyWrapper\Individual
{
...
try
{
	...
	if( kDEBUG_PARENT )
	{
		...
		echo( '$test->EntityAffiliation( "default", ":domain:individual://authority/collection:identifier;" );' );
		$test->EntityAffiliation( "default", ":domain:individual://authority/collection:identifier;" );
		echo( kSTYLE_HEAD_POS );
		echo( kSTYLE_ROW_POS );
		echo( kSTYLE_ROW_PRE );
		echo( kSTYLE_HEAD_PRE );
