 ...
 *======================================================================================*/
	...
	protected function executeListParameterConstants()
	{
		...
		$ref[ "kAPI_OP_USER_INVITE" ] = kAPI_OP_USER_INVITE;
		$ref[ "kAPI_OP_ADD_USER" ] = kAPI_OP_ADD_USER;
		$ref[ "kAPI_OP_GET_USER" ] = kAPI_OP_GET_USER;
		$ref[ "kAPI_OP_MOD_USER" ] = kAPI_OP_MOD_USER;
		$ref[ "kAPI_OP_GET_MANAGED" ] = kAPI_OP_GET_MANAGED;
		$ref[ "kAPI_OP_CHECK_USER_CODE" ] = kAPI_OP_CHECK_USER_CODE;
		$ref[ "kAPI_OP_UPLOAD_TEMPLATE" ] = kAPI_OP_UPLOAD_TEMPLATE;
		$ref[ "kAPI_OP_UPDATE_TEMPLATE" ] = kAPI_OP_UPDATE_TEMPLATE;
		...
		$ref[ "kAPI_PARAM_RESPONSE_FRMT_SCORE" ] = kAPI_PARAM_RESPONSE_FRMT_SCORE;
		...
		$ref[ "kAPI_RESULT_ENUM_DATA_STAT" ] = kAPI_RESULT_ENUM_DATA_STAT;
		...
		$ref[ "kAPI_QUERY_OFFSETS" ] = kAPI_QUERY_OFFSETS;
		$ref[ "kAPI_REFERRER" ] = kAPI_REFERRER;
		$ref[ "kAPI_SESSION" ] = kAPI_SESSION;
		$ref[ "kAPI_SESSION_ID" ] = kAPI_SESSION_ID;
		$ref[ "kAPI_SESSION_TYPE" ] = kAPI_SESSION_TYPE;
		$ref[ "kAPI_SESSION_RUNNING" ] = kAPI_SESSION_RUNNING;
		$ref[ "kAPI_PROCESS_ID" ] = kAPI_PROCESS_ID;
