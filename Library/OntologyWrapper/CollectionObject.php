 ...
 *======================================================================================*/
	 ...
	 * Aggregate results
	 *
	 * This method should perform a query and return an array containing the aggregation of
	 * all resulting objects, their referenced objects and their tags.
	 *
	 * The method will return an array structured as follows:
	 *
	 * <ul>
	 *	<li><tt>status</tt>: This element will contain the status of the operation:
	 *	 <ul>
	 *		<li><tt>state</tt>: This element will hold <tt>ok</tt> if the operation was
	 *			succesful or <tt>error</tt> if there was an error.
	 *		<li><tt>msg</tt>: This element will hold the error message if there was an
	 *			error.
	 *		<li><tt>affected</tt>: This element will hold the affected count of the query,
	 *			this value is an integer indicating the number of records affected, this is
	 *			not dependent on the number of records returned, it represents the total
	 *			number of records selected by the query.
	 *		<li><tt>returned</tt>: This element will hold the number of records returned by
	 *			the query, including paging parameters.
	 *		<li><tt>start</tt>: This element will hold the starting record number, or the
	 *			number of skipped records.
	 *		<li><tt>limit</tt>: This element will hold the maximum number of records
	 *			requested.
	 *	 </ul>
	 *	<li><tt>ids</tt>: This element will contain the list of native identifiers returned
	 *		by the query referring to the objects requested by the query.
	 * </ul>
	 *
	 * The remaining elements of the array will be indexed by the object <tt>kSEQ_NAME</tt>
	 * constant and will contain the list of objects, as arrays, corresponding to the
	 * <tt>kSEQ_NAME</tt> constant. For instance, all tags used by the objects returned by
	 * the query will be stored in the element named <tt>{@link Tag::kSEQ_NAME}</tt>.
	 *
	 * The method expects the following parameters:
	 *
	 * <ul>
	 *	<li><b>$theIterator</b>: This parameter represents the result of the {@link matchAll()}
	 *		operation, this operation <em>must</em> return an iterator of objects,
	 *		{@link kQUERY_OBJECT} option.
	 *	<li><b>$theStart</b>: This parameter represents the starting record number, or the
	 *		number of records to be skipped, if omitted, it will default to
	 *		{@link kQUERY_START_DEFAULT}.
	 *	<li><b>$theLimit</b>: This parameter represents the maximum number of records to be
	 *		returned, if omitted, it will default to {@link kQUERY_LIMIT_DEFAULT}.
	 *	<li><b>$theLanguage</b>: This parameter represents the default language for
	 *		language string properties, it will default to {@link kQUERY_LANG_DEFAULT}.
	 * </ul>
	 *
	 ...
	 *
	 * @param IteratorObject		$theIterator		Results iterator.
	 * @param integer				$theStart			Start record number.
	 * @param integer				$theLimit			Maximum number of records.
	 * @param string				$theLanguage		Default language strings.
	 *
	 * @access public
	 *
	 * @throws Exception
	 */
	abstract public function aggregateResults( IteratorObject $theIterator,
											   $theStart = kQUERY_START_DEFAULT,
											   $theLimit = kQUERY_LIMIT_DEFAULT,
											   $theLanguage = kQUERY_LANG_DEFAULT );
