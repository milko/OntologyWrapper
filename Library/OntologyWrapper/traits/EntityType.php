 ...
 * EntityType.php
 *
 * This file contains the definition of the {@link EntityType} trait.
 */
 ...
 * EntityType trait
 *
 * This trait implements a method for managing the entity type offset,
 * {@link kTAG_ENTITY_TYPE}. The method allows the management of the individual elements of
 * the enumerated set.
 *
 ...
 *======================================================================================*/
	 ...
	 * Manage entity kind
	 *
	 * This method can be used to add, retrieve and delete individual entity type enumerated
	 * values; to manage the enumerated set as a whole, use the {@link kTAG_ENTITY_TYPE}
	 * offset.
	 *
	 ...
	 *
	 * @see kTAG_ENTITY_TYPE
	 *
	 * @uses manageSetOffset()
	 */
	public function EntityType( $theValue, $theOperation = NULL, $getOld = FALSE )
	{
