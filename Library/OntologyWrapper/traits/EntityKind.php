 ...
 * EntityKind.php
 *
 * This file contains the definition of the {@link EntityKind} trait.
 */
 ...
 * EntityKind trait
 *
 * This trait implements a method for managing the entity kind offset,
 * {@link kTAG_ENTITY_KIND}. The method allows the management of the individual elements of
 * the enumerated set.
 *
 ...
 *======================================================================================*/
	 ...
	 * Manage entity kind
	 *
	 * This method can be used to add, retrieve and delete individual entity kind enumerated
	 * values; to manage the enumerated set as a whole, use the {@link kTAG_ENTITY_KIND}
	 * offset.
	 *
	 ...
	 *
	 * @see kTAG_ENTITY_KIND
	 *
	 * @uses manageSetOffset()
	 */
	public function EntityKind( $theValue, $theOperation = NULL, $getOld = FALSE )
	{
