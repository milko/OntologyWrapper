 ...
 * Category.php
 *
 * This file contains the definition of the {@link Category} trait.
 */
 ...
 * Category trait
 *
 * This trait implements a method for managing the categories offset, {@link kTAG_CATEGORY}.
 ...
 *======================================================================================*/
	 ...
	 * Manage category
	 *
	 * This method can be used to add, retrieve and delete individual category enumerated
	 * values; to manage the enumerated set as a whole, use the {@link kTAG_CATEGORY}
	 * offset.
	 *
	 ...
	 */
	public function Category( $theValue, $theOperation = NULL, $getOld = FALSE )
	{
