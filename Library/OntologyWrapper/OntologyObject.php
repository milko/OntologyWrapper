 ...
 *======================================================================================*/
	...
	static function InternalOffsets()
	{
		return array( kTAG_NID, kTAG_ROW, kTAG_CLASS,
					  ...
					  kTAG_SESSION_REF, kTAG_TRANSACTION_REF, kTAG_FILE_REF,
					  kTAG_COLLECTION_REF, kTAG_DATABASE_REF,
					  kTAG_GEOMETRY, kTAG_RADIUS,
					  kTAG_FULL_TEXT_10, kTAG_FULL_TEXT_06, kTAG_FULL_TEXT_03,
					  kTAG_FILE_NAME, kTAG_FILE_UPLOAD_DATE, kTAG_FILE_LENGTH,
					  kTAG_FILE_CHUNK_SIZE, kTAG_FILE_MD5,
					  kTAG_FILE_MIME_TYPE, kTAG_FILE_ALIASES );						// ==>
