	...
	public function init()
	{
		...
		if( $this->mConnection instanceof \Memcached )
		{
			...
			$objs = array( 1 => array( '_id' => 1, '1' => ':ns',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Namespace' ),
									   '4' => array( ':type:string' ) ),
						   2 => array( '_id' => 2, '1' => ':lid',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Local identifier' ),
									   '4' => array( ':type:string' ) ),
						   3 => array( '_id' => 3, '1' => ':gid',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Global identifier' ),
									   '4' => array( ':type:string' ) ),
						   4 => array( '_id' => 4, '1' => ':seq',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Sequence' ),
						   ...
						   7 => array( '_id' => 7, '1' => ':data-kind',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Cardinality type' ),
									   '4' => array( ':type:set' ) ),
						   8 => array( '_id' => 8, '1' => ':label',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Label' ),
									   '4' => array( ':type:language-strings' ) ),
						   9 => array( '_id' => 9, '1' => ':definition',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Definition' ),
									   '4' => array( ':type:language-strings' ) ),
						   ...
						   11 => array( '_id' => 11, '1' => ':connection:protocol',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Connection protocol' ),
									   '4' => array( ':type:string' ) ),
						   12 => array( '_id' => 12, '1' => ':connection:host',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Connection host' ),
									   '4' => array( ':type:string' ) ),
						   13 => array( '_id' => 13, '1' => ':connection:port',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Connection port' ),
									   '4' => array( ':type:int' ) ),
						   ...
						   17 => array( '_id' => 17, '1' => ':connection:collection',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Collection' ),
									   '4' => array( ':type:string' ) ),
						   18 => array( '_id' => 18, '1' => ':connection:options',
									   '6' => array( kTAG_LANGUAGE => 'en',
													 kTAG_TEXT => 'Connection options' ),
									   '4' => array( ':type:array' ) ),
