 ...
 *
 * <ul>
 *	<li><tt>{@link kSTATUS}</tt>: This element holds the status and iterator counters:
 *	 <ul>
 *		<li><tt>{@link kSTATE}</tt>: The value of this element will be <tt>ok</tt> if the
 *			operation was successful, or <tt>error</tt> on errors.
 *		<li><tt>{@link kMESSAGE}</tt>: If there was an error, this element will hold the
 *			error message.
...
class ResultAggregator
{
	 ...
	 * Status.
	 *
	 * This constant references the status block.
	 *
	 * @var string
	 */
	 ...
	 * State.
	 *
	 * This constant references the status state, the value will be the <tt>ok</tt> string
	 * or <tt>error</tt>, in case of an error.
	 */
	const kSTATE = 'stat';
	 ...
	 * Message.
	 *
	 * This constant references the status message string, this element will only be
	 * present if there was an error: it represents the error message.
	 */
	const kMESSAGE = 'msg';
 ...
 *======================================================================================*/
	...
	public function __construct( IteratorObject $theIterator )
	{
		...
		// Init status.
		//
		$this->mResults[ self::kSTATUS ]
			= array( self::kSTATE => 'ok',
					 self::kAFFECTED => $theIterator->affectedCount(),
