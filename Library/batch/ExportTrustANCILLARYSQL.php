...
/**
 * Create ancillary data for trust SAMPSTAT ANCILLARY tables.
 *
 * This file contains routines to create trust SAMPSTAT SQL update script.
 *
...
// Inform.
//
echo( "\n==> Creating SQL script for MCPD:SAMPSTAT trust database.\n" );
...
try
{
	...
	// Handle ISO 3166-1.
	//
	generateSQL( 'MCPD:SAMPSTAT', $wrapper, $dc );
