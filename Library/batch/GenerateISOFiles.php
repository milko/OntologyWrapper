...
//
// Default label tag identifier.
//
define( "kOFFSET_LABEL", ":label" );

//
// Default definition tag identifier.
//
define( "kOFFSET_DEFINITION", ":definition" );
			...
			foreach( $xml_in->{'iso_3166_entry'} as $record )
			{
				...
				if( $record[ 'alpha_3_code' ] !== NULL )
				{
					...
					if( $record[ 'official_name' ] !== NULL )
					{
						...
						$names[ kOFFSET_DEFINITION ][ 'en' ] = $tmp;
